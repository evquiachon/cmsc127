<?php
    ...
    $sql = "SELECT sb.senate_bill_no, sb.title, sb.status, s.name, sb.date_filed FROM senate_bill sb, senator s WHERE sb.senator_filed_id = s.senator_id AND senate_bill_no = '$senate_bill_no'";
