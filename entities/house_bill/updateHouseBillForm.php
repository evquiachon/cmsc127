...
<body>
    <div class="wrapper">
        <form action="updateHouseBill.php" method="post">

            <div class="form-group">
                <h3>Search</h3>
                <label>Find House Bill: </label>
                <?php
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "<select name='house_bill_no1' class='form-control'>";
                ...
                <input type="text" name="house_bill_no2" class="form-control">
                <label>Title: </label>
               ...
               <select name='status' class='form-control'>
                ...
                <?php
                    $sql2 = "SELECT DISTINCT name, house_member_id FROM house_member";
